...
function updateindom(el){ 
    let get = document.getElementById(el.id);
    get.firstChild.nodeValue = el.name;
}
var storage = firebase.storage();
let image2 = document.getElementById('image')
function upload(){
    let file = image2.files;
    
    let storageRef = storage.ref().child('images/' + file[0].name);
